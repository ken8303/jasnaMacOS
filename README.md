...
On a 10-GPU-core Apple M4 with Xcode 27 beta 4, the tiled FP16 deformable
convolution measured 1.17–1.20 ms median versus roughly 9.0–9.4 ms for the first
SIMD version and 16.2–17.7 ms for the direct baseline (13.5–15.1× speedup). Its maximum
